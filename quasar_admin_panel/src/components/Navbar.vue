    ...
    <div class="navbar-collapse">
      <ul class="navbar-align">
        <li class="nav-item">
          ...
          <div
            :class="{ show: isDropdownAlertOpen }"
            class="dropdown-alert"
            aria-labelledby="alertsDropdown"
          >
            <div class="dropdown-alert-header">4 New Notifications</div>
        ...
        <li class="nav-item">
          ...
          <div :class="{ show: isDropdownAvatarOpen }" class="dropdown-avatar">
            <a class="dropdown-avatar-item" href="#"
              ><svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
            ...
            >
            <div class="dropdown-divider"></div>
            <a @click.prevent="logout" class="dropdown-avatar-item" href="#"
              ><svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
  ...
  methods: {
    ...
    documentClick(event) {
      ...
      if (
        ...
        !dropdownAlert.contains(event.target) &&
        !alertLink.contains(event.target) &&
        !avatarLink.contains(event.target)
      ) {
        // если клик был не по выпадающим меню
...
.dropdown-avatar-item:hover,
.dropdown-avatar-item:focus {
...
.dropdown-divider {
  border-top: 1px solid hsla(0, 0%, 100%, 0.175);
  height: 0;
  margin: 0.5rem 0;
  opacity: 1;
  overflow: hidden;
...
.dropdown-avatar {
  ...
  --bs-dropdown-border-color: hsla(0, 0%, 100%, 0.175);
  --bs-dropdown-border-radius: 0.2rem;
  --bs-dropdown-border-width: 1px;
  --bs-dropdown-inner-border-radius: calc(0.2rem - 1px);
  --bs-dropdown-divider-bg: hsla(0, 0%, 100%, 0.175);
