          ...
          <q-form>
            <div class="modal-edit-user-header">
              ...
              <button
                ...
                @click.prevent="modalEditUserClose"
              />
            </div>
            <div class="modal-edit-user-body">
              ...
              <div
                ...
                :class="{
                  'form-input-container-valid': nameInputIsValid,
                  'form-input-container-invalid': !nameInputIsValid,
                }"
              >
                <label class="input-label">Имя</label>
                <input
                  type="text"
                  class="modal-edit-user-input"
                  v-model="modalName"
                  required
                />
              ...
              <div
                class="form-input-container"
                :class="{
                  'form-input-container-valid': emailInputIsValid,
                  'form-input-container-invalid': !emailInputIsValid,
                }"
              >
              ...
              <div
                class="form-input-container"
                :class="{
                  'form-input-container-valid': phoneInputIsValid,
                  'form-input-container-invalid': !phoneInputIsValid,
                }"
              >
              ...
              <div
                class="form-input-container"
                :class="{
                  'form-input-container-valid': sipInputIsValid,
                  'form-input-container-invalid': !sipInputIsValid,
                }"
              >
              ...
              <div
                class="form-input-container"
                :class="{
                  'form-input-container-valid': passwordInputIsValid,
                  'form-input-container-invalid': !passwordInputIsValid,
                }"
              >
              ...
              <div
                class="form-input-container"
                :class="{
                  'form-input-container-valid': roleInputIsValid,
                  'form-input-container-invalid': !roleInputIsValid,
                }"
              >
            ...
            <div class="modal-edit-user-footer">
              ...
              />
              <q-btn
                v-if="!modalAddOrEditUser"
                @click.prevent="modalEditUserSubmit"
              ...
              <q-btn
                v-if="modalAddOrEditUser"
                @click.prevent="modalAddUserSubmit"
                class="modal-footer-save"
                type="submit"
                label="Добавить"
              />
...
export default {
  ...
  data() {
    return {
      ...
      pagination: {
        // объект настроек пагинации в таблице
  ...
  computed: {
    ...
    paginationLabel() {
      const { from, to, total } = this.$q.pagination.normalize(
        this.pagination,
        this.rows.length
      );
      ...
      handler() {
        this.selectedString =
          this.selected.length === 0
            ? ""
            : `${this.selected.length} пользовател${
                this.selected.length > 1
                  ? this.selected.length > 4
                    ? "ей"
                    : "я"
                  : "ь"
              } выбран${this.selected.length > 1 ? "о" : ""} из ${
                this.rows.length
              }`;
      },
      immediate: true,
  ...
  methods: {
    ...
    deleteItemForSelectedList(userId) {
      console.log("ID: " + userId);
      if (this.selected.length > 0) {
        for (let i = 0; i < this.selected.length; i++) {
          if (this.selected[i].userId === userId) {
...
.form-input-container-valid .valid-label,
